...
const Kurti = () => {
  ...
  const filteredProducts = products.filter(
    (product) => product.category.toLowerCase() === "kurti"
  );
  return (
    <>
      <div className=" bg-gradient-to-br from-pink-100 to-purple-100">
        ...
        <ProductCardUI
          pageTitle="Kurti Collection"
          pageDesc="Explore the elegance of our handpicked Kurti"
          notFoundtitle="No Products Found"
          notFoundDesc="Looks like we are out of Kurti's at the moment!"
