...
const Palazzo = () => {
  ...
  const filteredProducts = products.filter(
    (product) => product.category.toLowerCase() === "palazzo"
  );
  ...
  return (
    <>
      <div className=" bg-gradient-to-br from-pink-100 to-purple-100">
        ...
        <ProductCardUI
          pageTitle="Palazzo Collection"
          pageDesc="Explore the elegance of our handpicked palazzo"
          notFoundtitle="No Products Found"
          notFoundDesc="Looks like we are out of palazzo at the moment!"
