...
const Twopiecesuits = () => {
  ...
  const filteredProducts = products.filter(
    (product) => product.category.toLowerCase() === "two-piece kurti"
  );
  ...
  return (
    <>
      <div className=" bg-gradient-to-br from-pink-100 to-purple-100">
        ...
        <ProductCardUI
          pageTitle="Two-Piece Suits  Collection"
          pageDesc="Explore the elegance of our handpicked Two-Piece Suits"
          notFoundtitle="No Products Found"
          notFoundDesc="Looks like we are out of Two-Piece Suits   at the moment!"
