...
const Duppata = () => {
  ...
  const filteredProducts = products.filter(
    (product) => product.category.toLowerCase() === "dupatta"
  );
  ...
  return (
    <>
      <div className=" bg-gradient-to-br from-pink-100 to-purple-100">
        ...
        <ProductCardUI
          pageTitle="Duppatta Collection"
          pageDesc="Explore the elegance of our handpicked Duppattas"
          notFoundtitle="No Products Found"
          notFoundDesc="Looks like we are out of Duppattas at the moment!"
